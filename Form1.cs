namespace Shopping_List
{
    public partial class Form1 : Form
    {
        ...
        {
            string itemName;
            bool flowControl = ValidateAndGetItemName(out itemName);
            if (!flowControl)
            {
                return;
            }
        ...
        private bool ValidateAndGetItemName(out string itemName)
        {
            itemName = textBox1.Text.Trim();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Ensure the name is not blank
            bool flowControl = ValidateandRemoveItemName(itemName);
            if (!flowControl)
            {
                return;
            }
        ...
        private bool ValidateandRemoveItemName(string itemName)
        {
            if (string.IsNullOrEmpty(itemName))
            {
